...
export function PostCard({ post, children }: PostCardProps) {
 ...
 return (
    <div className="bg-white p-6 pt-0 rounded-lg shadow hover:shadow-lg transition flex flex-col justify-between">
      <Link href={`/post/${id}`} className="block mb-4">
        <div className="h-60 lg:h-75 w-full relative mb-4">
          <Image
